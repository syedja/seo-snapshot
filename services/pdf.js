...
async function generatePDF(report, email) {
  ...
  doc.setFontSize(22);
  doc.text('SEO Snapshot Report', M, 22);
  ...
  doc.text(`Generated ${now}  ·  Delivered to ${email}  ·  socialpostinginc.com`, M, 43);
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.setFontSize(7);
    doc.setFont('helvetica', 'normal');
    doc.text('© 2026 Social Posting Inc. · SEO Snapshot · socialpostinginc.com', W / 2, 292, { align: 'center' });
